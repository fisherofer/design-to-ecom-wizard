...
export function MarketClock() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-md border border-border bg-card/60 px-3 py-1.5 text-xs font-mono">
      <span className={cn("h-1.5 w-1.5 rounded-full pulse-dot", dot)} />
      <span className="text-muted-foreground uppercase tracking-wider">
        {clock.is_open ? "US Market Open" : "US Market Closed"}
      </span>
